...
![Folder structure manscode.com](https://manascode.com/wp-content/uploads/2019/07/how-to-add-authentication-in-django-1-1024x588.png)<figcaption>Folder structure | Manascode.com</figcaption></figure>Open the views.py file that you have just created and write the first views called Register. In that case now we are going to use **Django Function Based** **views**. So create a function called **register**.
...
![](https://manascode.com/wp-content/uploads/2019/07/tempaltes-folder-in-django-manascode.png)<figcaption>Create templates folder and signup.html file</figcaption></figure>After creating the signup.html file paste this lines of code in the html file.
...
![Signup view page in django manascode](https://manascode.com/wp-content/uploads/2019/07/Signup-page-in-django-manascode-1024x584.png)<figcaption>Registration view</figcaption></figure>BOOM 😲🎆🎇 Now we have the **sign up page** ready. You can just fill the details and click sing up button to test the **Registration** function we wrote in the **step 3**.
...
![](https://manascode.com/wp-content/uploads/2019/07/Logout-view-manascode-1024x237.png)<figcaption>Logical Login, Register, Logout</figcaption></figure>But now if you click on the logout it will do nothing. So now we need to add the Logout function to the urls.py file as I did for the Login url.
