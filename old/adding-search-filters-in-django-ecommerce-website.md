...
date: '2020-03-14T15:31:47+00:00'
status: publish
permalink: /adding-search-filters-in-django-ecommerce-website
author: 'Manas Paul'
excerpt: ''
type: post
id: 355
thumbnail: ../uploads/2020/03/Adding-search-filters-in-Django-eCommerce-website.jpg
category:
    - Django
...
<div class="hcb_wrap">```
<pre class="prism line-numbers lang-python" data-file="checkout/views.py" data-lang="Python">```
...
</div>Just use this code instead of the payment view code, the checkout issue will solve. ( If you’re in another country use your country’s currency code instead of the India code ) .
...
<div class="hcb_wrap">```
<pre class="prism line-numbers lang-python" data-file="carts/views.py" data-lang="Python" data-line="4,5,6,7,8">```
# Add to Cart View
...
<div class="hcb_wrap">```
<pre class="prism line-numbers lang-python" data-file="carts/models.py" data-lang="Python" data-line="6">```
# Cart Model
...
</div>Now we should check the cart item has already purchased or not while run a query on our cart model. So to do that, we just need to pass an extra arguments to query.

Here is new cart create view code.

<div class="hcb_wrap">```
<pre class="prism line-numbers lang-python" data-file="cart/views.py" data-lang="Python" data-line="8">```
# Add to Cart View
...
</div>> Before installing make sure your virtual environment is activated.
...
<div class="hcb_wrap">```
<pre class="prism line-numbers lang-python" data-file="products/filters.py" data-lang="Python">```
...
</div>In this file, we are creating a class called ProductFilter which inherits FilterSet from django filter. Then we have created two fields one is for name which is `Charfield`. Another one is price which I used `RangeField` cause I think people can filter products based on their budget.
...
<div class="hcb_wrap">```
<pre class="prism line-numbers lang-python" data-file="products/views.py" data-lang="Python">```
class Home(ListView):
    model = Product
...
</div>In the class based view, we can get the context using `get_context_data()` function, then we are just passing our filter form as an extra context. By the don’t forget to import the form.
...
</div>### Add the form into template
...
<div class="hcb_wrap">```
<pre class="prism line-numbers lang-python" data-file="home.html" data-lang="Python">```
...
</div>Now in the home.html the context variable will be `filter.qs` instead of `object_list`. Save all the files you edited and run the server. Now you should get a filter for your django ecommerce website.
