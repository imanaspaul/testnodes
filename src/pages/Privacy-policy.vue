<template>
    ...
    <div class="posts content-box">
        ...
        <div class="about-us">
            <p>Who we are
            Our website address is: <g-link to='/'>https://manascode.com</g-link>
            ...
            <p>Your personal information is contained in secured networks and is only accessible by a limited number of persons who have special access rights to such systems, and are required to keep the information confidential. In addition, all sensitive you supply is encrypted via Secure Socket Layer (SSL) technology.</p>
            ...
            <p>Occasionally at our discretion, we may provide a link to third party websites these third party sites have separate and independent privacy policies. We, therefore, have no responsibility or liability for the content and activities of these linked sites.</p>
